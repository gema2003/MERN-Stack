...
const SingUp = () => {
	...
	const googleError = (error) => alert(`${error} / Google Sign In was unsuccessful, try again leter`);
		...
		<Container component="main" maxWidth="xs">
			<Paper className={classes.paper} elevation={3}>
				...
				<form className={classes.form} onSubmit={handleSubmit}>
					...
					<GoogleLogin
						clientId='260756377604-b3q5euc2t0godd9m2f21o9avuns7pjc8.apps.googleusercontent.com'
						render={(renderProps) => (
